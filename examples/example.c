...
int main(void) {
  ...
  error = sidereal_time(jd_ut1, 0.0, delta_t, NOVAS_TRUE_EQUINOX, NOVAS_IAU2006_METHOD, NOVAS_FULL_ACCURACY, &gast);
  if(error != 0) {
  ...
  error = ter2cel(jd_ut1, 0.0, delta_t, NOVAS_IAU2006_METHOD, NOVAS_FULL_ACCURACY, NOVAS_GCRS, x_pole, y_pole, vter, vcel);
  if(error != 0) {
