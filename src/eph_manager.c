 ...
 */
{
  ...
  double pos_moon[3] = { 0.0, 0.0, 0.0 }, vel_moon[3] = { 0.0, 0.0, 0.0 }, pos_earth[3] = { 0.0, 0.0, 0.0 }, vel_earth[3] =
          { 0.0, 0.0, 0.0 };
  double target_pos[3] = { 0.0, 0.0, 0.0 }, target_vel[3] = { 0.0, 0.0, 0.0 }, center_pos[3] = { 0.0, 0.0, 0.0 }, center_vel[3] = { 0.0,
          0.0, 0.0 };
  ...
  if((target == earth) || (center == earth)) do_moon = 1;
  if((target == moon) || (center == moon)) do_earth = 1;
  if((target == 12) || (center == 12)) do_earth = 1;
  ...
  else error = state(jed, center, center_pos, center_vel);
