...
/**
 * (<i>for internal use only</i>) Checks if two Julian dates are equals under the precision
 * that can be handled by this library. In practive two dates are considered equal if they
 * agree within 10<sup>-8</sup> days (or about 1 ms) of each other.
 *
