...
### Fixed
 ...
 - #272: `CMakeLists.txt` exported the `core` target by another name of `supernovas`, which messed up the CMake package dependencies and also __vcpkg__. Fixed by not renaming `core` target. (thanks to prookion).
