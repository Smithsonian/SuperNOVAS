...
int main() {
  ...
  if(!test.check("invalid lon", !Ecliptic(NAN, 30.0 * Unit::deg, Equinox::icrs(), 10.0 * Unit::au).is_valid())) n++;
  if(!test.check("invalid lat", !Ecliptic(45.0 * Unit::deg, NAN, Equinox::icrs(), 10.0 * Unit::au).is_valid())) n++;
  if(!test.check("invalid lat > 90", !Ecliptic(45.0 * Unit::deg, 91.0 * Unit::deg, Equinox::icrs(), 10.0 * Unit::au).is_valid())) n++;
  if(!test.check("invalid dis", !Ecliptic(45.0 * Unit::deg, 30.0 * Unit::deg, Equinox::icrs(), NAN).is_valid())) n++;
  if(!test.check("invalid dis < 0", !Ecliptic(45.0 * Unit::deg, 30.0 * Unit::deg, Equinox::icrs(), -1.0).is_valid())) n++;
  ...
  if(!test.check("as_galactic() invalid", !x.to_galactic().is_valid())) n++;

  Ecliptic a = Ecliptic(Angle(45.0 * Unit::deg), Angle(30.0 * Unit::deg), Equinox::icrs(), Distance(10.0 * Unit::au));
  ...
  Ecliptic b = Ecliptic(Angle(45.0 * Unit::deg), Angle(30.0 * Unit::deg), Equinox::j2000(), Distance(10.0 * Unit::au));
  ...
  Ecliptic c = Ecliptic(Angle(45.0 * Unit::deg), Angle(30.0 * Unit::deg), Equinox::b1950(), Distance(10.0 * Unit::au));
  ...
  Ecliptic d = Ecliptic(Angle(45.0 * Unit::deg), Angle(30.0 * Unit::deg), Equinox::tod(Time::b1900()), Distance(10.0 * Unit::au));
  ...
  Ecliptic e = Ecliptic(Angle(20.0 * Unit::deg), Angle(15.0 * Unit::deg), Equinox::icrs(), Distance(10.0 * Unit::au));
  ...
  if(!test.check("as_ecliptic()", a.to_galactic() == ga0)) {
