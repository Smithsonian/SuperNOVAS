...
int main() {
  ...
  if(!test.check("invalid lon", !Spherical(NAN, 30.0 * Unit::deg, 10.0 * Unit::au).is_valid())) n++;
  if(!test.check("invalid lat", !Spherical(45.0 * Unit::deg, NAN, 10.0 * Unit::au).is_valid())) n++;
  if(!test.check("invalid lat > 90", !Spherical(45.0 * Unit::deg, 91.0 * Unit::deg, 10.0 * Unit::au).is_valid())) n++;
  if(!test.check("invalid dis", !Spherical(45.0 * Unit::deg, 30.0 * Unit::deg, NAN).is_valid())) n++;
  if(!test.check("invalid dis < 0", !Spherical(45.0 * Unit::deg, 30.0 * Unit::deg, -1.0).is_valid())) n++;

  Spherical a(45.0 * Unit::deg, 30.0 * Unit::deg, 10.0 * Unit::au);
  ...
  Spherical b(Angle(45.0 * Unit::deg), Angle(30.0 * Unit::deg), Distance(10.0 * Unit::au));
